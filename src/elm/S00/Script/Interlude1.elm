...
script : Script
script =
    [ Line Oldman "「斯くして我々は封ぜられた区画へと足を踏み入れることになったのです。」"
    ...
    , Line Zack """
        「侵略説を唱えるオカルトマニアの間では、彼女は物語のスパイスとして有名なようです。
    ...
    , Line Oldman "「我々が超自然の存在を初めて体感したのも、そのAnderson女史の、奥まった場所にある居室から出ようとした時のことでした。」"
    ]
