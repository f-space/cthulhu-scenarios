    ...
    Document "終幕"
        [ article "終幕"
            [ branch "撃破した場合"
                ...
                , oldman "「奴が崩れ去るのを確認し、安堵に集中を解いたその刹那、私は地面に叩かれるような衝撃を受けました。」"
                , zack "「あの日、研究所を襲ったという局地的大地震ですか…。」"
                , oldman "「何かに頭をぶつけたことで気を失い、次に目を覚ましたとき、私は病院のベッドに横たわっていました。」"
                ]
            , branch "全滅した場合"
                [ direction """
                ...
                """
                , oldman "「私の意識があったのはそこまでで、次の瞬間には病院のベッドに横たわっていました。」"
                , narrative "老人は軽く目を閉じ、深く息を吸い込み、そして吐いた。"
                , oldman "「回復した私に告げられた『事実』は、局地的大地震に巻き込まれたという不可解かつ現実的なものでした。」"
                ]
